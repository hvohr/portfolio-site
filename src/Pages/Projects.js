  ...
  return (
    <section>
      ...
      {showBareMin && <section className='modal-container'>
        ...
        <a className='about-greeting-resume' href="https://github.com/hvohr/bare-minimum" target="_blank" rel="noopener noreferrer"> View Source Code</a>
        <a className='about-greeting-resume' href="https://bare-minimum.vercel.app/" target="_blank" rel="noopener noreferrer">View Deployed Link</a>
      </section>}
      {showPort && <section className='modal-container'>
        ...
        <a className='about-greeting-resume' href="https://github.com/hvohr/portfolio-site" target="_blank" rel="noopener noreferrer">View Source Code</a>
      </section>}
      {showClear && <section className='modal-container'>
        ...
        <a className='about-greeting-resume' href="https://github.com/hvohr/clearskies" target="_blank" rel="noopener noreferrer">View Source Code</a>
        <a className='about-greeting-resume' href="https://clearskies.vercel.app/" target="_blank" rel="noopener noreferrer">View Deployed Link</a>
      </section>}
    </section>
  )
}
