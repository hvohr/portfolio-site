  ...
  return (
    <section>
      <div className='bare-minimum-container'>
        <h3>Bare Minimum</h3>
        <button onClick={() => handleOpen('BareMin')}>View More</button>
      ...
      <div className='clear-skies-container'>
        <h3>Clear Skies</h3>
        <button onClick={() => handleOpen('Clear')}>View More</button>
        {showClear && <section className='modal-container'>
          ...
          <p>Technologies Used: Javascript, ReactJS, HTML/CSS, Cypress, Webpack, FETCH API's</p>
          ...
          <button onClick={() => handleClose('Port')}>Close</button>
        </section>}
      </div>
      <div className='porfolio-container'>
        ...
        {showPort && <section className='modal-container'>
          ...
          <p>Technologies Used: React, Javascript, ReactJS, HTML/CSS</p>
